...
<xsl:import href="/layout/tools/talent-page.xsl"/>
<xsl:output method="html" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd" doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN"/>

<xsl:template match="characterInfo">

	<link rel="stylesheet" type="text/css" href="/css/tools/talent-calc.css"/>
...
<xsl:template name="charContent">
	...
	<script type="text/javascript" src="/js/character/talents.js"/>
...
<xsl:template name="petName">
	...
	<xsl:apply-templates mode="printf" select="$loc/strs/character/str[@id='charLevelStr']">
		<xsl:with-param name="param1" select="$pet/@level"/>
