...
<xsl:import href="/layout/guild/header.xsl" />
...
<xsl:template name="guildContent">
	...
	<xsl:for-each select="guild/members/character">
		...
		<script type="text/javascript" src="/js/guild/guild-stats.js"></script>
	</xsl:for-each>
...
<!--            <td><div id = "classIcon9" class="classicon"><a href="#" onClick="changeStats(raceSelected, 9, document.guildStats.inputMinLevel.value, document.guildStats.inputMaxLevel.value, genderSelected, completeArray); return false;" onmouseover="showTip(classStringArray[9][0])" onmouseout="hideTip()"></a><p class="right"></p></div></td>-->
		</tr>
		<tr>
