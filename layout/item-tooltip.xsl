...
<xsl:template name="printItemDropChance2">
			  ...
			  <xsl:choose>
			    ...
			    <xsl:when test = "$theSource = 'sourceType.creatureDrop'" >				
			      ...
			      <xsl:variable name = "theDropRate">
				    <xsl:call-template name = "printItemDropChance2"><xsl:with-param name = "dropRate" select = "../itemSource/@dropRate" /></xsl:call-template>
				  </xsl:variable>
