 ...
 * guild-stats.php
 * 
 * The script handles caching and output of the guild-stats.xml with respective values.
 *
...
//try using cache
$cachefile = FILECACHEFOLDER. md5("guild-stats.xml_".$guildname."_on_".$realmName."_lang_".$language) .".cache";
...
if($guild->getId()){
	...
	$xml = fgettemplate('./xml-templates/guild-stats-basic.xml', $guild->prepareGuildSheet());
