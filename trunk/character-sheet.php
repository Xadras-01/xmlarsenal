 ...
 * character-sheet.php
 * 
 * The script handles caching and output of the character-sheet.xml with respective values.
 *
 * @author Amras Taralom <amras-taralom@streber24.de>
 * @version 1.0, last modified 2009/08/14
 * @package XMLArsenal
...
if($char->getId()){
	...
	$xml = fgettemplate('./xml-templates/character-sheet-basic.xml', $char->prepareCharacterSheet());
