...
<xsl:template name="miniCharSearchTemplate">
	...
	<div class="ps"><div class="ps-bot"><div class="ps-top">
			<div class="result-banner">
				<a id="search-defaulter" href="javascript: miniSearchPanelInstance.revertToDefault()" class="search-default staticTip" onmouseover="setTipText('{$loc/strs/unsorted/str[@id='armory.mini-search.label.character.default']}')"/>
...
<xsl:variable name="guildName" select="$locGuild/page/guildInfo/guild/@realm"/>
	...
	<div id="divBackTop"/>	
	<div id="divRight"/>
	<div id="divForwardBot"/>
	<div id="divPagingBot"/>	

	<script type="text/javascript" src="/js/paging/right/functions.js"/>
...
<!--	<div class="division">
	...
	<div class="ps"><div class="ps-bot"><div class="ps-top">
			<div class="result-banner">
				<a id="search-defaulter" href="javascript: miniSearchPanelInstance.revertToDefault()" class="search-default" onmouseover="showTip('{$loc/strs/unsorted/str[@id='armory.mini-search.label.character.default']}')" onmouseout="hideTip()"/>
...
<xsl:template name="miniItemSearchTemplate">
	...
	<script type="text/javascript" src="/js/{$lang}/results-items.js"/>
	<script type="text/javascript">
	...
	var theString = "";
				...
				theString += '<td><q><a id="'+rightArray[i][0][2]+'" class = "rarity'+ rightArray[i][0][3] +' staticTip itemToolTip" href="http://eu.wowarmory.com/item-info.xml?'+ rightArray[i][0][2] +'">';
				theString += truncateString(rightArray[i][1][0], theTrunc);
				theString += '</a></q></td>';
				theString += '</tr>';
				return theString;
...
<!--	<div class="division">
	...
	<div class="data">
      ...
      <xsl:choose>
        <xsl:when test="$path/guild/members/@page &gt; 1">
	      <a href="javascript:miniSearchPanelInstance.setDefaultPageNumber({$path/guild/members/@page - 1});" class="uptab"/>
	    </xsl:when>
	    <xsl:otherwise>
	      <a class="uptab-off"/>
	    </xsl:otherwise>
    ...
    <tr>
      ...
      <td><div><p/></div></td><td><a><strong/></a></td>
      <td><q>
      	<xsl:choose>
            <xsl:when test="@url">
                <a><strong>
    ...
    <xsl:choose>
      <xsl:when test="$path/guild/members/@page &lt; $path/guild/members/@maxPage">
        <a href="javascript:miniSearchPanelInstance.setDefaultPageNumber({$path/guild/members/@page + 1});" class="downtab"/>
      </xsl:when>
      <xsl:otherwise>
        <a class="downtab-off"/>
      </xsl:otherwise>
...
<!--	<div class="division">
	...
	<div class="data">
      ...
      <xsl:choose>
        <xsl:when test="$path/@page &gt; 1">
	      <a href="javascript:miniSearchPanelInstance.setDefaultPageNumber({$path/@page - 1});" class="uptab"/>
	    </xsl:when>
	    <xsl:otherwise>
	      <a class="uptab-off"/>
	    </xsl:otherwise>
    ...
    <!-- jump forward one page -->
      <xsl:choose>
        ...
        <a href="javascript:miniSearchPanelInstance.setDefaultPageNumber({$path/@page + 1});" class="downtab"/>
      </xsl:when>
      <xsl:otherwise>
        <a class="downtab-off"/>
      </xsl:otherwise>
