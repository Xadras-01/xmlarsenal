...
<xsl:import href="/layout/character/achievements-async.xsl"/>

<xsl:variable name="MAX_ACHIEVEMENT_COMPARISON_CHARACTERS" select="4"/>

<xsl:template name="head-content">
    <link href="/css/character/achievements.css" rel="stylesheet" type="text/css" />
</xsl:template>
...
<xsl:template match="category" mode="nav-sub">
	<div class="nav-subcat">
		<a href="javascript:void(0)" onclick="Armory.Achievements.openSubcategory(this.parentNode, '{position()}')"><xsl:value-of select="@name"/></a>
	</div>
</xsl:template>
...
<xsl:template match="achievements|statistics" mode="ach">
	<div class="achievements">
		...
		<div class="achieve_rcol">
        	<div style="line-height:0"><img src="../images/achievements/achv_rcol_top.jpg"/></div>
