...
<xsl:variable name = "docArena" select = "document('/data/arenacost.xml')" />
...
<div id="hidePoints">
	...
	<div class="redrow">
		...
		<div><input onFocus = "this.select()" value = "0" name = "inputRating" type = "text" size = "4" onKeyUp = "javascript: traverseNames(this.name, this.value); calcPoints(this.value);" /></div>
	</div>
	<ul>
