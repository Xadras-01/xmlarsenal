...
function setFilterPage(whichPage, filterValue) {
	...
	if(theLang == "ko_kr" || theLang == "zh_cn" || theLang == "zh_tw"){
		theTrunc = 19;
	}else{
		theTrunc = 22;	
	}
  ...
  if (window.isArenaTeamsRight) {
	...
	printFlash('teamIconBoxresults2', '/images/icons/team/pvpemblems.swf', 'transparent', '', '#000000', '76', heightCalc, 'high', '', flashVarsString + '&#38;totalIcons='+theHeight, '');  
  }
