...
public function getItems(){ 
    ...
    $this->items = array(); 
    $res = @mysql_query("SELECT * FROM `item_instance` ii JOIN `character_inventory` ci ON ci.item = ii.guid WHERE ii.owner_guid=".$this->charid." AND ci.bag = 0 AND ci.slot >= 0 AND ci.slot < 19;", $this->pvedbconn); 
